...
import { MENU_ITEMS } from './pages_docente-menu';
// import { HttpErrorResponse } from '@angular/common/http';
// import { MenuService } from '../@core/data/menu.service';
import { ImplicitAutenticationService } from '../@core/utils/implicit_autentication.service';

@Component({
  selector: 'ngx-pages_docente',
  template: `
    <ngx-sample-layout>
...
export class Pages_DocenteComponent implements OnInit {
  ...
  private translateMenuTitle(menuItem: MenuItem, prefix: string = ''): void {
    ...
    try {
      key = (prefix !== '')
        ? Pages_DocenteComponent.getMenuItemKey(menuItem, prefix)
        : Pages_DocenteComponent.getMenuItemKey(menuItem);
    } catch (e) {
    ...
    if (menuItem.children != null) {
      ...
      menuItem.children.forEach((childMenuItem: MenuItem) => {
        ...
        this.translateMenuTitle(childMenuItem, Pages_DocenteComponent.trimLastSelector(key));
      });
    }
  }
